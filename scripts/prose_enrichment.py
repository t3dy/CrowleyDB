...
SAINT_NOTES = {
    "PRS_S001": "Maier helps the portal keep Rosicrucianism, alchemy, and courtly erudition in the same historical lane. His presence matters because Crowley and later readers could treat him as a disciplined scholar, a symbolic alchemist, and a model of learned synthesis all at once. The archive also uses him to show how learned esotericism can travel through court culture without losing its technical density, which is why his name keeps turning up wherever number, emblem, and moral allegory meet. That makes him one of the clearest bridges between Renaissance number lore and the later occult habit of reading texts as layered correspondences. He also helps the portal explain why Renaissance alchemy and later ceremonial magic often speak in the same language of emblems, numerical harmonies, and hidden operations.",
    "PRS_S002": "De Molay survives in the archive less as a historical administrator than as a symbol of martyrdom and delayed revenge. Crowleyan and Golden Dawn readers repeatedly make him into a figure of templar endurance, secret transmission, and vindication after destruction. The entry therefore keeps the execution history and the symbolic afterlife in the same frame, since the second is often more important to the occult literature than the first. He becomes a useful example of how an order can turn defeat into mythic authority, and how a historical death can be re-edited into a ritual claim about continuity. The figure is also a reminder that occult memory often prefers endurance under pressure to clean institutional succession, which is why his name carries so much narrative force.",
    "PRS_S003": "Rosenkreuz functions as a founding cipher, letting the archive point to mythic origin stories without pretending they are simple biography. His value lies in the way Rosicrucian literature turns hidden authorship into a teaching device, which later occult systems borrow whenever they need an origin that cannot be reduced to ordinary chronology. The portal keeps him as a name whose main force is generative rather than factual, and that generative force is one reason his figure keeps reappearing wherever occult orders need a story about concealed transmission, invisible succession, and reawakened knowledge. He therefore belongs in the archive as a conceptual ancestor, not merely as a person in a historical chain.",
    "PRS_S004": "Paracelsus matters because his experimental medicine and symbolic cosmology give Thelemic retrospection a Renaissance ancestor it can actually use. Crowley and his successors could point to Paracelsus when they wanted precedent for a magician-physician who combined practical experiment with a theory of signatures, correspondences, and inner powers. That makes him useful not only as a historical person, but as a pattern for how knowledge can move between science, medicine, and magic. He also lets the archive show that the symbolic life of a figure can matter just as much as the factual one, since his afterimage is as influential as his biography. In the portal he stands for the older European habit of making natural philosophy, healing, and magic speak to each other without apology.",
    "PRS_S005": "Apollonius supplies a model of holy charisma and philosophical wandering that later occult readers repeatedly recruit into their own lineages. He functions in the archive as a philosophical traveler whose authority comes from encounter, discipline, and transformation rather than office or institution. The entry keeps that double life visible, since he is both a historical figure and a recurrent exemplar for magical self-fashioning. His presence also helps the portal keep the Neopythagorean and miracle-working inheritance visible, which matters because Crowley and his precursors often treated charisma, number, and wandering as part of the same symbolic inheritance. That makes him a useful bridge between late antique philosophy and later esoteric idealization of the adept as a living proof of doctrine.",
}
...
WORK_NOTES = {
    "WKS_001": "The text is treated as the source-note for the whole system, because it names the voices, the law, and the problem of interpretation in one place. The revelation also becomes a theory of reading, since Crowley forces the reader to decide when the law speaks as doctrine, when it speaks as symbol, and when it deliberately refuses a single stable explanation.",
    "WKS_002": "This work is one of the clearest places where Crowley turns doctrine into a training manual, so the portal reads it as method rather than slogan. It matters because it translates mystical aspiration into staged discipline, making yoga, concentration, ritual, and ethical calibration part of one practical curriculum.",
    "WKS_003": "The desert visionary record gives the archive one of its richest examples of Crowley's attempt to turn experience into a usable spiritual text. The book's value lies in the way the diary-like record turns the Aethyrs into a staged initiation, where vision is at once personal ordeal, doctrinal claim, and literary form.",
    "WKS_004": "As a correspondences table, it behaves like a lookup engine for the rest of the system, which is why the portal treats it as infrastructure as much as literature. The tables are not neutral data: they show Crowley making inherited magical order into a reusable, comparative machine for reading symbols across the corpus.",
    "WKS_005": "The tarot manual is where Crowley's symbolic revisions become explicit, so the entry keeps the deck, the commentary, and the doctrinal logic together. It is especially important because Crowley makes the cards argue with Golden Dawn inheritance, turning the book into both a tarot guide and a revisionary manifesto.",
    "WKS_006": "The periodical voice matters because it lets doctrine, ritual, and polemic share the same print space, which is a key move in Crowley's publishing strategy. The issue also reads as an editorial experiment in how a new occult movement can present itself through miscellaneous forms, not just single-system treatises.",
    "WKS_007": "The book compresses teaching into aphorism and paradox, making it a useful example of how Crowley used literary form to discipline interpretation. Its short pieces are miniature initiation problems that make the reader work through contradiction rather than passively receive a lesson.",
    "WKS_008": "The letter format keeps the work intimate while still making it a public piece of magical pedagogy, which is part of its lasting appeal. The epistolary voice lets Crowley stage counsel, correction, and doctrine as if they were private conversation while still building a durable instructional text.",
    "WKS_009": "This issue helps bridge the New York material and the later organizational ambitions of Crowley's system, so it is read as a hinge text. It marks the point where order history, editorial identity, and the public presentation of Thelema become increasingly inseparable.",
    "WKS_010": "The manual remains one of the clearest routes into Crowley's mature magical method because it translates theory into an actual training sequence. The page keeps its practical cadence visible because the book is not just about ideas; it is about habits, drills, and repeatable work.",
    "WKS_011": "The autobiography is indispensable, but the portal keeps its self-construction visible so the reader can tell memory from performance. The book is as much a literary mask as a life record, and the archive preserves that double nature because Crowley is always narrating himself into the doctrine he wants the reader to accept.",
    "WKS_012": "The novel matters because it translates occult discipline into fiction, making the Abbey years and the therapeutic rhetoric easier to read together. It also shows Crowley testing whether initiation, addiction, and transformation can be dramatized in a form that reaches readers outside the occult circle.",
}
...
def expand_work_summary(
    ...
    extras.append("The prose also keeps room for the book's genre, since Crowley uses revelation, manual, correspondence, table, aphorism, fiction, and autobiography as distinct ways of making doctrine legible.")
    extras.append("That genre signal helps the reader understand why two Crowley texts can be equally important while asking the reader to do very different kinds of interpretive work.")
